...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2">
            ...
            <form method="POST" action="{{ route('customer.rental.upload-documents', $rental) }}" enctype="multipart/form-data">
                ...
                <div style="margin-bottom: 24px; padding: 20px; border: 2px dashed var(--border-subtle); border-radius: 12px; background: var(--black-1);">
                    <div style="display: flex; align-items: flex-start; gap: 16px;">
                        ...
                        <div style="flex: 1;">
                            <h4 style="font-size: 14px; font-weight: 600; margin-bottom: 4px;">Rental Contract</h4>
                ...
                <div style="margin-bottom: 24px; padding: 20px; border: 2px dashed var(--border-subtle); border-radius: 12px; background: var(--black-1);">
                    <div style="display: flex; align-items: flex-start; gap: 16px;">
                        ...
                        <div style="flex: 1;">
                            <h4 style="font-size: 14px; font-weight: 600; margin-bottom: 4px;">Valid ID</h4>
                            <p style="font-size: 12px; color: var(--text-muted); margin-bottom: 12px;">
        ...
        <!-- Important Notes -->
        <div class="card" style="background: #F59E0B10; border-color: #F59E0B;">
            <h4 style="font-size: 14px; font-weight: 600; margin-bottom: 12px; color: #F59E0B;">
            ...
            <ul style="font-size: 13px; color: var(--text-secondary); margin: 0; padding-left: 20px;">
                <li style="margin-bottom: 8px;">Both contract and valid ID are required before vehicle pickup</li>
